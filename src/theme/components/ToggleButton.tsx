...
const toggleBtnCustomVariants: ComponentsVariants<Theme>['MuiToggleButton'] = toggleBtnColors.map(
  (color) => ({
...
const toggleBtnGroupCustomVariants: ComponentsVariants<Theme>['MuiToggleButtonGroup'] =
