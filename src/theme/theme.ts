...
import { SupportedLocales, ThemePreset } from 'config';
...
export const createTheme = ({
  ...
  const effectivePreset = preset ?? 'default-light';
      ...
      colorSchemes: {
        light: {
          palette: applyPrimaryOverride(
            lightPalettes[effectivePreset] ?? lightPalettes['default-light'],
            primaryColor,
            'light',
          ),
        ...
        dark: {
          palette: applyPrimaryOverride(
            darkPalettes[effectivePreset] ?? darkPalettes['default-dark'],
            primaryColor,
            'dark',
          ),
