...
const SlimSidenav = dynamic(() => import("./sidenav/SlimSidenav"));
const StackedSidenav = dynamic(() => import("./sidenav/StackedSidenav"));
const TopNavStacked = dynamic(() => import("./topnav/TopNavStacked"));
const TopnavSlim = dynamic(() => import("./topnav/TopnavSlim"));
